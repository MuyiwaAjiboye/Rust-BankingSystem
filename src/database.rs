...
//For Creating and storing Accounts
...
//for depositing money into currently active account
...
//For transferring money between accounts from currently active account
pub fn transfer(
    amount: &str,
    pin: &str,
    account_number1: &str,
...
//For Deleting A currently Active Account 
...
//For showing current balance of currently active account
